...
export class AlterUserAddVault1721917783946 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" ADD "instagramFile" character varying`);
        await queryRunner.query(`ALTER TABLE "users" ADD "linkedInFile" character varying`);
        await queryRunner.query(`ALTER TABLE "users" ADD "whatsAppFile" character varying`);
        await queryRunner.query(`ALTER TABLE "users" ADD "facebookFile" character varying`);
        await queryRunner.query(`ALTER TABLE "users" ADD "messengerFile" character varying`);
        await queryRunner.query(`ALTER TABLE "users" ADD "telegramFile" character varying`);
        await queryRunner.query(`ALTER TABLE "users" ADD "xUsername" character varying`);
        await queryRunner.query(`ALTER TABLE "users" ADD "tikTokUsername" character varying`);
        await queryRunner.query(`ALTER TABLE "users" ADD "points" integer DEFAULT '0'`);
    }
